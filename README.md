...
Please note that currently when moving or copying cases between Blaise servers, the servers must use the same login credentials and HTTP binding as they are picked up from App.config for both servers.
